...
import {
  applyApPaymentAction,
  type ApplyApPaymentState,
} from "@/app/actions/apply-ap-payment";
...
const initialState: ApplyApPaymentState = {};

export function ApplyApPaymentRow({
  openItemId,
  defaultAmount,
  cashAccounts,
}: {
  ...
  const [state, formAction] = useFormState(applyApPaymentAction, initialState);
