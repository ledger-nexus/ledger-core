...
describe("v0.9 NS SuiteAnalytics Phase 5: toNsConsolidatedTrialBalance", () => {
  it("emits NS SubsidiaryElimination-canonical consolidation shape", async () => {
    const body = toNsConsolidatedTrialBalance(
      {
        ...
        cumulativeTranslationAdjustment: new Decimal("100.0000"),
    ...
    expect(body.translation.active).toBe(true);
    expect(body.translation.ratesByEntity).toEqual({
      ACME_NS1: null,
      ACME_NS2: "1.30",
    });
    expect(body.translation.cta).toBe("100.0000");
    expect(body.totals.cumulativeTranslationAdjustment).toBe("100.0000");
    ...
    const body = toNsConsolidatedTrialBalance(
      {
        ...
        consolidatedTotalCredit: new Decimal("0.0000"),
        cumulativeTranslationAdjustment: new Decimal("0.0000"),
