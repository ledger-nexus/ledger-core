...
| 16 | **GDPR/CCPA right-to-deletion request can't be fulfilled** | 2 | 3 | 6 | No procedure yet; financial records are explicitly excepted from right-to-deletion under most regulations but PII fields aren't. Need a documented response procedure (`data-classification.md` gap). | HS | Open |
